...
{
    public class RCPatientController : Controller
    {
        private readonly PatientsContext _context;

        public RCPatientController(PatientsContext context)
        {
            _context = context;
        }
